...
Teste localhost:9216/metrics. \
Pegue http_request_duration_seconds_sum e joga no /graph.
...
Agregação: Se eu quiser fazer tipo um "group by" do SQL eu posso colocar "by (job)" no final da última query acima. \
Vai mostrar a soma de cada job, cada linha será a soma de um job.
